        ...
        <nav class="site-nav" aria-label="Navigation principale">
            <div class="navbar-inner">
                ...
                <div class="nav-collapsible">
                    ...
                    <a class="nav-login-btn" href="pages/login.php">Connexion</a>
                    <a class="nav-login-btn primary" href="pages/register.php">Inscription</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <main class="home-main">
        ...
        <section id="filiere-section" class="home-section">
            ...
            <div class="filiere-grid" aria-label="Liste des filieres">
                <a class="filiere-card" href="pages/sio.php">
                    <h4>BTS SIO</h4>
                    <p>Services Informatiques aux Organisations</p>
                </a>
                <a class="filiere-card" href="pages/ciel.php">
                    <h4>BTS CIEL</h4>
