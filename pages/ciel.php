...
$getStudent = $conn->prepare("SELECT * FROM etudiant LEFT JOIN filiere ON etudiant.filiere_id = filiere.id WHERE filiere.titre = 'BTS CIEL' ");
$getStudent ->execute();
  ...
  <body>
    ...
    <main>
      ...
      <section class="promotion-grid">
          ...
          <!-- Ajout automatique des card et des datas -->
          <?php foreach ($studentsByFiliere as $student) : ?>
              <div class="student-block">
                  <div class="student-photo">
                      <img src="<?php echo $student['photo']; ?>" alt="Photo de <?php echo $student['nom'] . ' ' . $student['prenom']; ?>"><!-- Récuperation de la photo de l'étudiant -->
              </div>

              <div class="content-card">
                  <div class="student-name"><?php echo $student['nom'] . ' ' . $student['prenom']; ?></div><!-- Récuperation du nom et du prénom -->
                  <div>
                      <a href="mailto:<?php echo $student['mail']; ?>" class="table-mail">Contacter</a> <!-- récuperation du email -->
                      <p><?php echo $student['titre']; ?></p><!-- Récuperation du titre de la filliere -->
                  </div>
              </div>
          </div>
          <?php endforeach; ?>
